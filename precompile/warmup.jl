...
for notebook in ["introduction.jl",
                 "generalized_linear_regression.jl",
                 "supervised_learning.jl",
                 "pca.jl",
                 "flexibility.jl",
                 "gradient_descent.jl",
                 "model_evaluation.jl",
    ...
    @show notebook
    try
        Base.include(Module(Symbol(randstring(10))),
                     joinpath(@__DIR__, "..", "notebooks", notebook))
    catch e
        @error e
    end
end
...
sleep(10) # i am pulling these numbers out of thin air
