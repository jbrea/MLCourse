...
RUN julia --project=/home/pluto/MLCourse -e "import Pkg; Pkg.instantiate(); Pkg.precompile(); using MLCourse"

# The "default command" for this docker thing.
CMD ["julia", "--project=/home/pluto/MLCourse", "-e", "import PlutoSliderServer; PlutoSliderServer.run_directory(\".\"; static_export = true, run_server = true, Export_baked_state = false, SliderServer_port=1234 , SliderServer_host=\"0.0.0.0\")"]
