...
RUN julia -e 'import Pkg; Pkg.activate(joinpath(Pkg.devdir(), "MLCourse")); Pkg.instantiate(); using MLCourse; cp(MLCourse.PrecompilePlutoCourse._CONFIG[].sysimage_artifact, "/home/MLCourse/precompile/mlcourse.so")'
