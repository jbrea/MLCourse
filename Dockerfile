...
CMD ["julia", "--project=/home/MLCourse", "-e", "import PlutoSliderServer; PlutoSliderServer.run_directory(\".\"; notebook_paths = [\"index.jl\", \"notebooks/introduction.jl\", \"notebooks/supervised_learning.jl\", \"notebooks/generalized_linear_regression.jl\", \"notebooks/flexibility.jl\", \"notebooks/model_evaluation.jl\", \"notebooks/regularization.jl\"], static_export = true, run_server = true, Export_baked_state = false, SliderServer_port=8000, SliderServer_host=\"0.0.0.0\", Export_slider_server_url=\"https://bio322.epfl.ch/\")"]
