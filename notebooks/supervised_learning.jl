...
# ╔═╡ f63c050e-eefe-11eb-08a9-b57452c4e44f
...
`data, labels = ` have a look at the [manual](https://docs.julialang.org/en/v1/manual/functions/#Multiple-Return-Values).
"
...
Our goal is to predict the wind speed in Lucerne from 5 hours old pressure measurements.
"
...
predict(mach, DataFrame(x = [0.5, 1.5]))
...
md"Next we actually generate data from the data generator defined in the blackboard example. For reproducibility we will fix the seed of the random number generator."
...
# ╔═╡ f63c060a-eefe-11eb-232d-ab1a9f3cd3bc
md"**Exercise**

Change the noise level σ, the size of the training data n and the seed with the sliders above and observe the training and the test losses. Write down your observations.
"
